            ...
            >
              ...
              >
                <Link
                  ...
                  className="block text-gray-300 hover:text-white transition-colors duration-200 bg-slate-600 hover:bg-slate-700 text-3xl p-4 rounded-full hover:rounded-full"
                >
                  Request A Quote
                </Link>
              </motion.div>
